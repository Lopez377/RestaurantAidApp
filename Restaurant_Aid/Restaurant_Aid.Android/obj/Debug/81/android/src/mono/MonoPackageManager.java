...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "Restaurant_Aid.Android.dll" comes first in this list. */
		"Restaurant_Aid.Android.dll",
		"FormsViewGroup.dll",
		"Newtonsoft.Json.dll",
		"Plugin.MapsPlugin.Abstractions.dll",
		"Plugin.MapsPlugin.dll",
		"Prism.dll",
		"Prism.Forms.dll",
